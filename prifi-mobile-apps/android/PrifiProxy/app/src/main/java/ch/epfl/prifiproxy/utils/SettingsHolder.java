...
public class SettingsHolder {
    ...
    public static SettingsHolder load(Context context) {
        ...
        holder.doDisconnectWhenNetworkError = prifiPrefs.getBoolean(context.getString(R.string.prifi_config_disconnect_when_error), false);
    ...
    public boolean save(Context context) {
        ...
        editor.putBoolean(context.getString(R.string.prifi_config_disconnect_when_error), doDisconnectWhenNetworkError);
        editor.apply();
        return true;
    }
    ...
    public boolean isDoDisconnectWhenNetworkError() {
        return doDisconnectWhenNetworkError;
    }

    public void setDoDisconnectWhenNetworkError(boolean doDisconnectWhenNetworkError) {
        this.doDisconnectWhenNetworkError = doDisconnectWhenNetworkError;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (doDisconnectWhenNetworkError != that.doDisconnectWhenNetworkError) return false;
