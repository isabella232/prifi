...
public class SettingsActivity extends AppCompatActivity {
    ...
    private Switch prifiOnlySwitch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prifiOnly = prifiPrefs.getBoolean(getString(R.string.prifi_config_prifionly), true);
        ...
        prifiOnlySwitch = findViewById(R.id.prifiOnlySwitch);
        ...
        prifiOnlySwitch.setOnCheckedChangeListener((buttonView, isChecked) -> applyPrifiOnlyChecked(isChecked));
    }
    ...
    protected void onStart() {
        ...
        prifiOnlySwitch.setChecked(prifiOnly);
    }

    private void applyPrifiOnlyChecked(boolean isChecked) {
        try {
        ...
        editor.putBoolean(getString(R.string.prifi_config_prifionly), isChecked);
        editor.apply();
