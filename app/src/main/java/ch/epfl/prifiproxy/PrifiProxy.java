...
public class PrifiProxy extends Application {
    ...
    private void initPrifiConfig() {
        ...
        final boolean defaultPrifiOnly;
        ...
        try {
            ...
            defaultPrifiOnly = !PrifiMobile.getMobileDisconnectWhenNetworkError();
        } catch (Exception e) {
        ...
        if (isFirstInit) {
            ...
            editor.putBoolean(getString(R.string.prifi_config_prifionly), defaultPrifiOnly);
            // Copy default values
            ...
            final boolean prifiOnly = prifiPrefs.getBoolean(getString(R.string.prifi_config_prifionly), true);
            ...
            try {
                ...
                if (prifiOnly != defaultPrifiOnly) {
                    PrifiMobile.setMobileDisconnectWhenNetworkError(!prifiOnly);
                }
